...
export default function FeaturedProducts({
  ...
  // g trae { id, uid, to, name, price, slug, category? ... }
  ...
  // Filtrado por búsqueda (nombre, categoría, slug)
      ...
      <div className="max-w-7xl mx-auto mb-6 md:mb-8" id="featured-products">
        ...
        <div className="mt-4 max-w-md md:max-w-sm lg:max-w-md">
          <SearchBar
            value={query}
            onChange={setQuery}
            placeholder="Buscar vestidos por nombre, estilo o color…"
          />
          {query && (
            ...
            {filteredGroups.length === 0 && (
              <li className="col-span-full">
                <EmptyStateGalactic
                  query={query}
                  onReset={() => setQuery('')}
                  title="No encontramos vestidos para esta búsqueda"
                  message="Probá con otra palabra clave, por ejemplo 'vestido', 'lentejuelas', 'sastrero' o un color."
                />
              </li>
            )}
          </motion.ul>
